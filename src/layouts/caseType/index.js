  ...
  const mainDataSource = new CustomStore({
    ...
    load: (loadOptions) => {
      try {
        return axiosInstance
          .post("/CaseType/Filter", prepareFilterBody(loadOptions))
          .then((response) => {
        ...
        console.error("CaseType/Filter:", error);
      }
    },
    insert: (values) => {
      return axiosInstance
        .post("/CaseType/InsertOrUpdate", values)
        .then((res) => {
          res = res.data;
        ...
        .catch((error) => {
          console.error("CaseType/InsertOrUpdate : " + error);
          throw "Hatalı işlem!";
        });
    },
    update: (key, values) => {
      ...
      return axiosInstance
        .post("/CaseType/InsertOrUpdate", post_values)
        .then((res) => {
          res = res.data;
    ...
    remove: (key) => {
      return axiosInstance
        ...
        .catch((error) => {
          console.error(`CaseType/Delete/${key}/delete : `, error);
          throw "Hatalı işlem!";
        });
    },
  });
