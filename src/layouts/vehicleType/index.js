...
const VehicleType = () => {
  ...
  const mainDataSource = new CustomStore({
    ...
    load: (loadOptions) => {
      try {
        return axiosInstance
          .post("/VehicleType/Filter", prepareFilterBody(loadOptions))
          .then((response) => {
        ...
        console.error("VehicleType/Filter:", error);
      }
    },
    insert: (values) => {
      return axiosInstance
        .post("/VehicleType/InsertOrUpdate", values)
        .then((res) => {
          res = res.data;
        ...
        .catch((error) => {
          console.error("VehicleType/InsertOrUpdate : " + error);
          throw "Hatalı işlem!";
        });
    },
    update: (key, values) => {
      ...
      return axiosInstance
        .post("/VehicleType/InsertOrUpdate", post_values)
        .then((res) => {
          res = res.data;
    ...
    remove: (key) => {
      return axiosInstance
        .delete(`/VehicleType/Delete?id=${key}`)
        .then((res) => {
          res = res.data;
        ...
        .catch((error) => {
          console.error(`VehicleType/Delete/${key}/delete : `, error);
          throw "Hatalı işlem!";
        });
    },
  });
