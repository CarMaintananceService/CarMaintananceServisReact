...
const StockCardBrands = () => {
  ...
  const mainDataSource = new CustomStore({
    ...
    load: (loadOptions) => {
      try {
        return axiosInstance
          .post("/StockCardBrand/Filter", prepareFilterBody(loadOptions))
          .then((response) => {
        ...
        console.error("StockCardBrand/Filter:", error);
      }
    },
    insert: (values) => {
      return axiosInstance
        .post("/StockCardBrand/insertOrUpdate", values)
        .then((res) => {
          res = res.data;
        ...
        .catch((error) => {
          console.error("StockCardBrand/InsertOrUpdate : " + error);
          throw "Hatalı işlem!";
        });
    },
    update: (key, values) => {
      ...
      return axiosInstance
        .post("/StockCardBrand/InsertOrUpdate", post_values)
        .then((res) => {
          res = res.data;
    ...
    remove: (key) => {
      return axiosInstance
        .delete(`/StockCardBrand/Delete?id=${key}`)
        .then((res) => {
          res = res.data;
        ...
        .catch((error) => {
          console.error(`StockCardBrand/Delete/${key}/delete : `, error);
          throw "Hatalı işlem!";
        });
    },
  });
...
export default StockCardBrands;
