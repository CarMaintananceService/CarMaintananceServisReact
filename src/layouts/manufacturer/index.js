...
const Manufacturer = () => {
  ...
  const mainDataSource = new CustomStore({
    ...
    load: (loadOptions) => {
      try {
        return axiosInstance
          .post("/Manufacturer/Filter", prepareFilterBody(loadOptions))
          .then((response) => {
        ...
        console.error("Manufacturer/Filter:", error);
      }
    },
    insert: (values) => {
      return axiosInstance
        .post("/Manufacturer/InsertOrUpdate", values)
        .then((res) => {
          res = res.data;
        ...
        .catch((error) => {
          console.error("Manufacturer/InsertOrUpdate : " + error);
          throw "Hatalı işlem!";
        });
    },
    update: (key, values) => {
      ...
      return axiosInstance
        .post("/Manufacturer/InsertOrUpdate", post_values)
        .then((res) => {
          res = res.data;
    ...
    remove: (key) => {
      return axiosInstance
        .delete(`/Manufacturer/Delete?id=${key}`)
        .then((res) => {
          res = res.data;
        ...
        .catch((error) => {
          console.error(`Manufacturer/Delete/${key}/delete : `, error);
          throw "Hatalı işlem!";
        });
    },
  });
